...
public class ScanManager {
     ...
     * If an agent stop reporting, its keep alive value will reach to 0 and the agent will be deleted.<br>
     *
     * @param username
     *         the username of the agent
     * @throws NameNotFoundException
    ...
    /**
     * Create a new scanning agent with a scan task and a scan command to perform, and add it to the agents list.<br>
     *
     * @param username
     *         the username of the agent
     * @param scanTask
    ...
    /**
     * Update the task status in the task table (index page) if password was found or all scan commands were used.<br>
     *
     * @param password
     ...
     * If an agents keep alive reached to 0 - the thread will re-add the agents scan command to the relevant scan task
     * in the task list.
     */
